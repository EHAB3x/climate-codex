    ...
    <div className="insights relative overflow-hidden py-16">
      ...
      <div className="insights__container relative container mx-auto flex sm:flex-row flex-col items-center gap-8">
        ...
        <div className="insights__content flex flex-col gap-7">
          ...
          <p>
            Easily filter locations based on air quality and gas concentrations,
            including CO2 and methane levels. Stay informed and choose safer
            environments with real-time data.
          </p>

          <Link to={"/login"} className="secondary__btn mt-7">
            Log in
          </Link>
        </div>
      </div>
